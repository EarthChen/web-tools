...
export function Layout({ children, title, isDark: externalIsDark, onToggleTheme: externalToggle }) {
  // 如果没有外部控制，使用内部状态
  ...
  return (
    <div className={`min-h-screen flex flex-col ${isDark ? 'dark-gradient' : 'light-gradient'}`}>
      {/* 统一导航栏 */}
